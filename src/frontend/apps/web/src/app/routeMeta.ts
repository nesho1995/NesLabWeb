...
const titles: Record<string, Ctx> = {
  ...
  '/admin/empresa-caja': { kicker: 'La empresa', label: 'Caja: reglas y montos', subtitle: 'Turno, caja chica y politica.' },
  ...
  '/caja/cierre': { kicker: 'Caja', label: 'Cerrar el turno', subtitle: 'Cuente el efectivo y cierre con diferencia cero o justificada.' },
